...
label = pd.read_csv('results/customer_feature_matrix_v2.csv')
tot = len(label)
for i in label.CONTENT_TYPE_WATCHED.unique():
	temp = label.loc[label.CONTENT_TYPE_WATCHED == i]
	print(i, (len(temp)/tot)*100)